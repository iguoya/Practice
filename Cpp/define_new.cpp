...
int main ()
{
    std::cout << "Value of __LINE__ : " << 6 << std::endl;
    std::cout << "Value of __FILE__ : " << "define.cpp" << std::endl;
    std::cout << "Value of __DATE__ : " << "Jul 19 2019" << std::endl;
    std::cout << "Value of __TIME__ : " << "08:53:23" << std::endl;
